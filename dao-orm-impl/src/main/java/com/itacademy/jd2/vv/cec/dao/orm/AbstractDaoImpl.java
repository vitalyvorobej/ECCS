...
import com.itacademy.jd2.vv.cec.dao.api.BaseDao;
import com.itacademy.jd2.vv.cec.dao.api.filter.AbstractFilter;

public abstract class AbstractDaoImpl<T, ID> implements BaseDao<T, ID> {
	...
	public void delete(final ID id) {
		entityManager.createQuery(String.format("delete from %s e where e.id = :id", entityClass.getSimpleName())).setParameter("id", id)
				.executeUpdate();
	}
